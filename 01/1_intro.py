...
# # No. 5
# word = input('Masukkan kata / kalimat:').lower() # agar kata menjadi kecil semua
# cari = input(f"Input huruf yang ingin dicari jumlahnya dari '{word}': ").lower() # function agar mudah memasukkan apapun dari variabel atas
# word2 = word.replace(cari, '') # mengganti huruf yang di input ( cari ) dengan spasi supaya bisa dikurang, len word dengan len cari
# print(word2)
# print(f'huruf {cari} ada {len(word)-len(word2)} buah') # mengurangi jumlah huruf dari word dan word 2
...
#     print ('Jumlah Karakter:', len(masukan_kata))
# penghitung_kata()
